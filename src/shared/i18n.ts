...
const ja = {
  ...
  'settings.title': '設定',
  'settings.tab_layout': 'タブの表示',
  'settings.language': '表示言語',
  'settings.backend': 'バックエンド',
  'settings.backend_mock_desc': 'モック応答 — AI_BACKEND_URL が未設定です',
  'settings.backend_live_desc': '接続中 — {url}',
  'settings.backend_down_desc': '応答がありません — {url}',
  'settings.session': 'このセッション',
  'settings.session_value': 'タブ {tabs} · 休眠 {asleep} · グループ {groups}',
  'win.minimize': '最小化',
  'win.maximize': '最大化',
...
const en: Record<MessageKey, string> = {
  ...
  'settings.tab_layout': 'Tab layout',
  'settings.language': 'Interface language',
  'settings.backend': 'Backend',
  'settings.backend_mock_desc': 'Mock responses — AI_BACKEND_URL is not set',
  'settings.backend_live_desc': 'Connected — {url}',
  'settings.backend_down_desc': 'Not responding — {url}',
  'settings.session': 'This session',
  'settings.session_value': 'Tabs {tabs} · asleep {asleep} · groups {groups}',
